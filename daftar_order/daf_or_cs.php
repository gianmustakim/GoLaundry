      ...
      <div class="card-body">
         <div class="tabel-kontainer">
            <table class="tabel-transaksi">
               ...
               <tbody>
                  <?php 
                  if($nama == 'admin'){$cuci_satuan = query("SELECT * FROM tb_order_cs ORDER BY id_order_cs DESC");}
                  else{$cuci_satuan = query("SELECT * FROM tb_order_cs WHERE user = '$nama' ORDER BY id_order_cs DESC"); }
